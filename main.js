...
var AppComponent = /** @class */ (function () {
    function AppComponent(_service) {
        ...
        this.dataSource = [];
        this.displayedColumns = ['name', 'volume', 'amount'];
        this.loading = false;
    }
    ...
    AppComponent.prototype.getData = function () {
        var _this = this;
        this.loading = true;
        this._service.getСurrency().subscribe(function (data) {
            console.log(data);
            _this.dataSource = data.stock;
        }, function () { }, function () {
            _this.loading = false;
        });
    };
...
var AppService = /** @class */ (function () {
    function AppService(http) {
        this.http = http;
        this.url = 'http://phisix-api3.appspot.com/stocks.json';
    }
    AppService.prototype.getСurrency = function () {
...
module.exports = __webpack_require__(/*! C:\Users\ВиталийАлександрович\Desktop\test-pa-resultant\resultant\src\main.ts */"./src/main.ts");
